...
Примечание: денилист мутирующих глаголов в загрузчике каталога (`loadCatalog`) убран — единственная граница теперь курирование allowlist (`actions.json`); мутирующие записи допустимы, если добавлены осознанно.
